...
const PasswordRecoverOtp = () => {
  ...
  return (
    ...
    <View style={styles.subContainer}>
      ...
      Enter 4-digit code we just texted to your phone number, +84 999 999 999
      </Text>
    </View>
    ...
    <CustomButton title={'Continue'} onPress={() => {navigation.navigate('PasswordRecoverEmail')}} />
    <CustomButton
      title={'Resend code'}
...
export default PasswordRecoverOtp
